...
Configure Firewall
    [Documentation]    Open the firewall ports we need, using the instructions from our user docs
    # Ensure ssh is not closed, we do this in the blueprints for other images
